...
def parse_args():
    ...
    parser.add_argument('--train_data_path_list',
                        default='D:\postphd\pruning/rram_online_training/Unet_new/prepare_dataset/data_path_list/DRIVE/train.txt')
    parser.add_argument('--test_data_path_list',
                        default='D:\postphd\pruning/rram_online_training/Unet_new/prepare_dataset/data_path_list/DRIVE/test.txt')
